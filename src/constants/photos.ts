...
export const GALLERY_PHOTOS: Photo[] = [
  ...
  { id: 40, src: getImagePath('/images/gallery/greengrass/08.webp'), alt: 'greengrassの風景', description: '春にはしだれ桜が咲き、緑の山に彩りを与えてくれます。', tags: ['greengrass'] },
  ...
  { id: 44, src: getImagePath('/images/gallery/greengrass/12.webp'), alt: 'greengrassにあるしだれ桜', description: '2000年になった記念に植えました。', tags: ['greengrass'] },
  { id: 45, src: getImagePath('/images/gallery/greengrass/13.webp'), alt: 'greengrassにあるしだれ桜', description: '毎年見事に花を咲かせてくれます。26年経ち、大きくなりました。', tags: ['greengrass'] },
