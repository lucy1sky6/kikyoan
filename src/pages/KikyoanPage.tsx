          ...
          <ProfileCard
            ...
            text={
              <>
                ...
                <p className="mb-4">
                  能登半島地震をきっかけに、この古民家を利用し、皆さまのお役に立てることはできないか、模索していました。
                </p>
                <p className="mb-4">
            ...
            bottomText="富山県出身。能登の田舎暮らしは50年余り。電子オルガン（brother エミリオン）講師を25年。琴城流大正琴准教授、リフレクソロジーセラピストの顔も持つ。シャンソン、踊りも好む。"
            color="purple"
          />
        </div>
      </PricingSection>
      ...
      <PricingSection title="料金・予約について" color="purple" delay={0.8}>
        {!isSupportPrice ? (
          <PriceCard
            title="料金の目安"
            items={[
              { label: '1泊（1名様でも2名様でも）', price: '¥11,500' },
              { label: '1泊（3名様以降　※最大8名様まで宿泊可）', price: '1名様増で +¥6,800' },
              { label: '2泊目から', price: '1名様 ¥6,800' },
              { label: '小学生', price: '¥3,000（添い寝無料）', separator: 'お子様料金' },
              { label: '未就学児', price: '無料' },
            ]}
            note={
              <>
        ...
        <InfoCard title="予約について" color="purple">
          ...
          <p className="text-gray-700 mt-4">
            ご予約は Instagram のメッセージ（DM）または 0768-74-0072 まで、お気軽にご連絡ください。
          </p>
        </InfoCard>
        <div className="md:col-span-2">
